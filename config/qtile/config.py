...
keys = [
    ...
    Key([mod], "q", lazy.spawn("wezterm"), desc="Launch wezterm"),
    Key([mod], "b", lazy.spawn("firefox"), desc="Launch firefox"),
    Key([mod, "shift"], "b", lazy.spawn("firefox --private-window"), desc="Launch firefox in private browsing."),
    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.TextBox("Press &lt;M-Space&gt; to spawn", foreground="#d75f5f"),
